...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        public void ResetToDefault()
        {
            ...
            {
                ResetComposite(action, bindingIndex);
            }
            else
            {
        ...
        private void ResetComposite(InputAction action, int compositeIndex)
        {
            for (int i = compositeIndex + 1; i < action.bindings.Count && action.bindings[i].isPartOfComposite; ++i)
            {
                ...
                string oldOverridePath = partBinding.overridePath;
                ...
                foreach (InputAction otherAction in action.actionMap.actions)
                {
                    ...
                    {
                        if (otherAction.bindings[j].overridePath == partBinding.path)
                            otherAction.ApplyBindingOverride(j, oldOverridePath);
                    }
                }
            }
        }
